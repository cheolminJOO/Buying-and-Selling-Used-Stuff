...
`
export const DetailedPageBtn = styled.button`
...
`
export const WrapperPhotoBox = styled.div`
  display : flex;
  justify-content: center;
  align-items: center;
`
...
export const ComContentsBox = styled.input`
  width : 1200px;
  height : 161px;
  border : 1px solid gray;
  margin-top : 30px;
...
export const PassWordBox = styled.input`
  ...
  padding-left : 20px;
`
export const CommentTit = styled.div`
  width : 100px;
  height : 27px;
  font-weight : 500;
  font-size : 18px;
